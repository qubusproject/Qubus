#ifndef QUBUS_PATTERN_SUBSCRIPTION_HPP
#define QUBUS_PATTERN_SUBSCRIPTION_HPP
...
public:
    ...
    bool match(const BaseType& value, const variable<const subscription_expr&>* var = nullptr) const
    {

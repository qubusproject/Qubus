...
public:
    ...
    member_access_expr(std::unique_ptr<expression> object_, std::string member_name_);
...
inline std::unique_ptr<member_access_expr> member_access(std::unique_ptr<expression> object, std::string member_name)
{

...
isl_schedule_node* QUBUS_isl_map_schedule_node_thunk(isl_schedule_node* node, void* user)
{
...
{
    return schedule(isl_schedule_map_schedule_node_bottom_up(s.release(), &QUBUS_isl_map_schedule_node_thunk, &callback));
}

...
expression double_literal_expr::substitute_subexpressions(const std::vector<expression>& subexprs) const
{
...
expression float_literal_expr::substitute_subexpressions(const std::vector<expression>& subexprs) const
{
    QBB_ASSERT(subexprs.size() == 0, "invalid number of subexpressions");
...
expression integer_literal_expr::substitute_subexpressions(const std::vector<expression>& subexprs) const
{
    QBB_ASSERT(subexprs.size() == 0, "invalid number of subexpressions");

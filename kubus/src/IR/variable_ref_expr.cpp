...
variable_ref_expr::variable_ref_expr(variable_declaration declaration_)
...
expression variable_ref_expr::substitute_subexpressions(const std::vector<expression>& subexprs) const
{
